 ...
 * @since 3.2
 */
public abstract class DelegatingContextScheduledExecutorService<C> extends
		DelegatingContextExecutorService<C> implements ScheduledExecutorService {
	/**
	 * Creates a new {@link DelegatingContextScheduledExecutorService} that uses
	 * the specified context {@link C}.
	 *
	 ...
	 * {@link org.springframework.util.concurrent.DelegatingContextCallable}.
	 */
	public DelegatingContextScheduledExecutorService(
			ScheduledExecutorService delegateScheduledExecutorService,
			C context, ContextOps<C> contextOps) {
		super(delegateScheduledExecutorService, context, contextOps);
	}

	/**
	 * Creates a new {@link DelegatingContextScheduledExecutorService} that uses
	 * the current context {@link C} from the {@link ContextOps#getContext}.
	 *
	 * @param delegate the {@link ScheduledExecutorService} to delegate to. Cannot be
	 * null.
	 */
	public DelegatingContextScheduledExecutorService(
			ScheduledExecutorService delegate, ContextOps<C> contextOps) {
